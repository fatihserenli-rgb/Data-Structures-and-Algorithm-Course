...
/**
 * OneWire protokolünü implemente eden sınıftır.
...
public class OneWire implements Protocol{
    ...
    /**
     * OneWire protokolünü başlatır ve bağlantının açıldığını belirten 
     * bir mesaj ekler.
     */
    public OneWire() {
        messages = new Stack<>();
    ...
    /**
     * OneWire protokolünün adını döndürür.
     *
     * @return "OneWire" protokol adı.
     */
    @Override
    ...
    /**
     * OneWire bağlantısından veri okuma işlemini simüle eder.
    ...
    /**
     * OneWire bağlantısına veri yazma işlemini simüle eder.
    ...
    /**
     * OneWire bağlantısını kapatır ve tüm mesajları belirtilen log 
     * dosyasına kaydeder.
     *
